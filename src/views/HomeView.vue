<template>
  <main class="page-shell">
    ...
    <section class="primary-grid">
      ...
      <v-card class="panel trend-panel" elevation="0"><div class="trend-panel-header"><h2>Exception Trend</h2><div class="trend-controls"><div class="trend-chip-group" role="group" aria-label="Exception trend grouping"><v-chip :class="{ 'trend-chip-active': trendView === 'type' }" class="trend-chip" :color="trendView === 'type' ? '#457B9D' : '#1D3557'" pill :variant="trendView === 'type' ? 'tonal' : 'outlined'" @click="trendView = 'type'">By Exception Type</v-chip><v-chip :class="{ 'trend-chip-active': trendView === 'carrier' }" class="trend-chip" :color="trendView === 'carrier' ? '#457B9D' : '#1D3557'" pill :variant="trendView === 'carrier' ? 'tonal' : 'outlined'" @click="trendView = 'carrier'">By Carrier</v-chip></div><div class="trend-chip-group" role="group" aria-label="Exception trend metric"><v-chip :class="{ 'trend-chip-active': trendMetric === 'count' }" class="trend-chip" :color="trendMetric === 'count' ? '#457B9D' : '#1D3557'" pill :variant="trendMetric === 'count' ? 'tonal' : 'outlined'" @click="trendMetric = 'count'">Count</v-chip><v-chip :class="{ 'trend-chip-active': trendMetric === 'percent' }" class="trend-chip" :color="trendMetric === 'percent' ? '#457B9D' : '#1D3557'" pill :variant="trendMetric === 'percent' ? 'tonal' : 'outlined'" @click="trendMetric = 'percent'">% of Shipments</v-chip></div></div></div>
